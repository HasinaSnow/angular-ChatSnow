        ...
        <div class="text-color sm:flex items-center justify-center h-full w-full sm:p-3 lg:p-4 xl:p-6">
            <div class="fixed top-0 w-full sm:flex justify-between items-center py-4 hidden sm:px-3 md:px-5 lg:px-6">
                <div class="flex gap-2 items-center font-bold">
                    <p-avatar image="./images/logo-chatsnow.png" size="large" shape="circle"/> 
                    <span class="text-xl">ChatSnow</span>
                </div>

                <div class="flex gap-2">
                    <p-button routerLink="login" routerLinkActive="router-link-active"  label="Sign in" styleClass="m-0 shadow-lg"/>
                    <p-button routerLink="register" label="Sign up" variant="text" outlined="true" styleClass="m-0"/>
                </div>
            </div>
