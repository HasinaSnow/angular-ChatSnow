...
@Component({
    ...
    <div class="w-full flex items-center justify-between py-3 px-2 gap-1 border-b border-surface">
        ...
        <div class="flex items-center gap-1">
            <p-button icon="pi pi-arrow-left text-muted-color" rounded="true" class="md:hidden" size="large" variant="text" severity="secondary" />
        ...
        <!-- right -->
        <div class="flex items-center gap-1">
            <p-button icon="pi pi-search" variant="text" outlined="true" severity="secondary"/>
            <p-button icon="pi pi-cog" variant="text" outlined="true" severity="secondary"/>
        </div>
    </div>
    `
})
